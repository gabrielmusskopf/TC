...
"}")
        ...
        self.resultText = QtWidgets.QLabel(self.treeTab)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.resultText.setFont(font)
        self.resultText.setStyleSheet("QLabel{\n"
"color: rgb(255,255,255);\n"
"}")
        self.resultText.setText("")
        self.resultText.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.resultText.setObjectName("resultText")
        self.gridLayout_2.addWidget(self.resultText, 0, 0, 1, 1)
